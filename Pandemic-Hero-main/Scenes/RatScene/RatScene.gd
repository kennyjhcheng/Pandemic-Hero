...
func _ready():
	if OS.get_name()=="Android":
		instructionLabelText = "Tap to catch the mouse. It's harder than you think. \nAfter you catch it, hold your tap and keep the slider within the green area to inject the vaccine."
